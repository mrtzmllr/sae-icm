...
assert conf["interpretability"]["write_gsm8k_heap"], "Pass --interpretability.write_gsm8k_heap true; without it assign_datasets clobbers eval.dataset and the heap is built on meta-math."
