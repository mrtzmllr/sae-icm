...
from src.poet.config_adaptations import adapt_curriculum, assign_datasets, supported_dataset_pairs, model_specific_parameters, turn_off_trainable, assert_finetune_orthogonal, gradient_checkpointing, mathematical_dataset, meta_math_logging, meta_math_evaluation, model_path, register, return_z, set_eval_length_dataset
...
def adapt_config(conf):
    ...
    conf = supported_dataset_pairs(conf)
    conf = model_specific_parameters(conf)
