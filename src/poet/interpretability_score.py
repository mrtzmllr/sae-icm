...
assert conf["interpretability"]["write_gsm8k_heap"], "Pass --interpretability.write_gsm8k_heap true; dataset_score dereferences the heap's test-set indices, without it meta-math is loaded and the correct snippets are silently wrong."
